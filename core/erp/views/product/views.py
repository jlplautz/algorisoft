...
class ProductListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # create_url -> para encaminhar da list -> create product
        context['create_url'] = reverse_lazy('erp:product_create')
        context['list_url'] = reverse_lazy('erp:product_list')
        context['entity'] = 'Produtos'
        return context
...
class ProductCreateView(CreateView):
    ...
    template_name = 'product/../../templates/product/create.html'
...
class ProductDeleteView(DeleteView):
    model = Product
    template_name = 'product/../../templates/product/delete.html'
    success_url = reverse_lazy('erp:product_list')
